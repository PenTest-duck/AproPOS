            ...
            HStack (spacing: 0) {
                VStack {
                    ZStack(alignment: .top) {
                        ...
                        NavigationLink (destination: OrderViewOld()) {
...
struct OrderViewOld_Previews: PreviewProvider {
    static var previews: some View {
        OrderViewOld().previewInterfaceOrientation(.landscapeLeft)
    }
}
