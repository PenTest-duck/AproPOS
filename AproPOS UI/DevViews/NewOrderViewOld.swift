...
struct NewOrderViewOld_Previews: PreviewProvider {
    static var previews: some View {
        NewOrderViewOld().previewInterfaceOrientation(.landscapeLeft)
    }
}
